      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"><a href="#">Showroom Mobil</a></h2>
            <p><a href="#">Semua Produk Mobil Kami Bergaransi</a></p>
            <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5" >
              ...
              <li class="ftco-animate"><a href="https://api.whatsapp.com/send?phone=+6281382055381&text=saya ingin melakukan pembelian mobil." target='_BLANK'><span
			        ...
			        <li class="ftco-animate"><a href="https://m.facebook.com/muhamad.roin.58" target='_BLANK'><span class="icon-facebook" ></span></a></li>
