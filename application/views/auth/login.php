...
<html lang="id-ID">
    <head>
        ...
        <link href="<?php echo get_theme_uri('custom/auth/login/css/style6.css'); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo get_theme_uri('custom/auth/login/css/fontawesome-all.css'); ?>" rel="stylesheet" />
        <link href="//fonts.googleapis.com/css?family=Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    </head>
    <body>
        <h1>Login ke <a href="#">Showroom Mobil</a></h1>
        ...
        <footer>
            <p class="copyright-agileinfo"> &copy; 2022 <a href="#">Showroom Mobil </a></p>
        </footer>
