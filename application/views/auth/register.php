...
<head>
    ...
    <!-- Title Page-->
    <title>Daftar dan Buat Akun | Showroom Mobil</title>
    ...
    <!-- Main CSS-->
    <link href="<?php echo get_theme_uri('custom/auth/register/css/main6.css'); ?>" rel="stylesheet" media="all">
    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    <h2 class="title">Buat Akun <a href="#">Showroom Mobil</a</h2>
